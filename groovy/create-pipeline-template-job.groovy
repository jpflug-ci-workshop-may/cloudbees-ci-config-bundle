...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/jpflug-ci-workshop-may/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>jpflug-ci-workshop-may</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>jpflug-ci-workshop-may</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/jpflug-ci-workshop-may/pipeline-template-catalog.git</repositoryUrl>
              <traits>
